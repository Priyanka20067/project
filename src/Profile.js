...
const styles = StyleSheet.create({
  ...
  profileContainer: { alignItems: 'center', marginBottom: 20 ,flexDirection:'row', marginLeft:19,marginTop:20},
  ...
  rating: { fontSize: 13.6, color: '#FFD700' },
   tags:{marginLeft:19},
  tagsContainer: { flexDirection: 'row', justifyContent: 'center' ,marginTop:5 ,marginLeft:-5},
  tag: {
